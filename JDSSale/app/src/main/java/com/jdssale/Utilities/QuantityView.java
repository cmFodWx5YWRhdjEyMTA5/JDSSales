...
public class QuantityView extends LinearLayout implements View.OnClickListener {
    ...
    public interface OnQuantityChangeListener {
        void onQuantityChanged(int oldQuantity, int newQuantity, boolean programmatically,String TAG);
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        type=Typeface.createFromAsset(getContext().getAssets(), "fonts/Lato-Regular.ttf");
        ...
        quantityPadding = (int) a.getDimension(R.styleable.QuantityView_qv_quantityPadding, pxFromDp(10));
        ...
        mButtonRemove.setTypeface(type);
        ...
        mTextViewQuantity.setTypeface(type);
        mTextViewQuantity.setGravity(Gravity.CENTER);
        setQuantityTextColor(quantityTextColor);
        mTextViewQuantity.setPadding(dp10, dp10, dp10, dp10);
        ...
        addView(mButtonRemove, LinearLayout.LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        ...
        if (v == mButtonAdd) {
            if (quantity + 1 > maxQuantity) {
                ...
                if (onQuantityChangeListener != null)
                    onQuantityChangeListener.onQuantityChanged(oldQty, quantity, false,"add");
            }
            ...
            if (quantity - 1 < minQuantity) {
                ...
                mTextViewQuantity.setText(String.valueOf(quantity));
                if (onQuantityChangeListener != null)
                    onQuantityChangeListener.onQuantityChanged(oldQty, quantity, false,"sub");
            }
